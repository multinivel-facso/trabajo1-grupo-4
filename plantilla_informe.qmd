...
```{r echo=FALSE, warning=FALSE, message=FALSE, results='hide'}
graf_interacción <- plot_model(results_6,
           type = "int",
           terms = c("nacionalismo_cmc", "seguridad_gmc")) +
  labs(
    title  = "Interacción: Nacionalismo individual × Promedio de seguridad persibida por país",
    x      = "Nacionalismo (centrado)",
    y      = "Opinión sobre migración",
    colour = "Promedio de seguridad persibida por país"
  ) +
  scale_color_manual(values = c("#1b9e77", "#d95f02", "#7570b3")) +
  theme_minimal(base_size = 12) +
  theme(
